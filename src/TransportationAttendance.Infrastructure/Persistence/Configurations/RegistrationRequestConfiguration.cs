...
public class RegistrationRequestConfiguration : IEntityTypeConfiguration<RegistrationRequest>
{
    public void Configure(EntityTypeBuilder<RegistrationRequest> builder)
    {
        ...
        builder.Property(e => e.Latitude).HasColumnName("Latitude").HasPrecision(10, 8).IsRequired();
        builder.Property(e => e.Longitude).HasColumnName("Longitude").HasPrecision(11, 8).IsRequired();
